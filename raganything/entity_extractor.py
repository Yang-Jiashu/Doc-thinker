...
# Add LinearRAG to path if it exists
project_root = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
linear_rag_path = os.path.join(project_root, "LinearRAG", "src")
if os.path.exists(linear_rag_path) and linear_rag_path not in sys.path:
    sys.path.append(linear_rag_path)
...
class SpacyEntityExtractor(EntityExtractor):
    """Entity extractor using Spacy (from LinearRAG)"""
    ...
    def extract_entities(self, text: str, **kwargs) -> List[Dict[str, Any]]:
        ...
        # for general extraction if needed. But for LinearRAG mode, it's mostly about names.
