...
class RAGAnythingConfig:
    ...
    # ---
    relation_extraction_mode: str = field(default=get_env_value("RELATION_EXTRACTION_MODE", "lightrag", str))
    """Strategy for extracting relations/entities: 'lightrag' or 'hypergraph'."""
    ...
    """If false, skip HyperGraphRAG chunk ingestion/extraction and rely on LightRAG graph."""
