...
from raganything.knowledge_base import KnowledgeBaseManager
from raganything.knowledge_base_storage import KnowledgeBaseStorage
...
from raganything.twi_adapter import ThinkWithImageRunner
...
class RAGAnything(QueryMixin, ProcessorMixin, BatchMixin):
    ...
    async def _ensure_lightrag_initialized(self):
        ...
        try:
            ...
            try:
                ...
                try:
                    mpi = lightrag_params.get("max_parallel_insert")
                    if mpi is not None:
                        setattr(self.lightrag, "max_parallel_insert", int(mpi))
                except Exception:
                    pass
                await self.lightrag.initialize_storages()
                await initialize_pipeline_status()
    ...
    def _initialize_knowledge_graph(self):
        ...
        from raganything.knowledge_graph import FileKnowledgeGraphStorage
    ...
    def add_cognitive_memory(
        ...
        *,
        ...
        if not entry_id:
            return None
        try:
            from raganything.hypergraph.utils import compute_mdhash_id
